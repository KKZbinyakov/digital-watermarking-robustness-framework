...
if __name__ == "__main__":
    ...
    Embedding_Core.LSB.embedding(
        args={
            "image_path": "Asuka.jpg",
            "watermark_bits": "1000110100000000000000000000000010001101000000000000000000000000",
            "output_path": "embeded.jpg",
        }
    )
    ...
    print(
        "BER:",
        Expertise_Core.BER.expertise(
            args={"original_bits": "10001101000000000000000000000000", "extracted_bits": result}
        ),
    )
